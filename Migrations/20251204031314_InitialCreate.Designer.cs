...
namespace Inferno.Migrations
{
    ...
    [Migration("20251204031314_InitialCreate")]
            ...
            modelBuilder.Entity("Inferno.src.Core.Domain.Entities.Demon", b =>
                {
                    ...
                    b.Property<Guid>("CategoryCodCategoria")
                        .HasColumnType("TEXT");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("TEXT");

                    b.Property<string>("NomeDemo")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("CategoryCodCategoria");
            ...
            modelBuilder.Entity("Inferno.src.Core.Domain.Entities.Demon", b =>
                {
                    b.HasOne("Inferno.src.Core.Domain.Entities.Category", "Category")
                        .WithMany("Demons")
                        .HasForeignKey("CategoryCodCategoria")
